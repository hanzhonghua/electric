						...
						<table border="0" width="100%" id="table5">
							<tr>
								...
								<td align="left" bgColor="#f5fafe" class="ta_01"
									style="width: 64%"><select name="devType" id="devType"
									class="bg" onchange="getdevTypeChange(this)">
							...
							<tr>
								<td colspan="2"><IFRAME
										src="adjustMoreAddList.jsp?findFlag=0&devType=
		"
										name="dtype" id="dtype" frameBorder=0 width=335 scrolling=auto
										height=260></IFRAME></td>
							</tr>
						</table>
					</fieldset>
				</td>
					...
					<table cellSpacing="1" width=100% cellPadding="5" height="320"
						...
						<tr>
							...
							<td bgColor="#f5fafe" class="ta_01"><input name="startDate"
								type="text" class="bg" id="startDate"
								onclick="JavaScript:calendar(this)" size="10" readonly>&nbsp;<font
