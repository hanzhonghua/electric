							...
							<tbody>
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff"><font face="宋体"
										color="red"> <input name="devName" type="text"
											maxlength="25" id="devName" size="19" value="UPS44444"
											disabled></font></td>
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff" width="224"><input
										name="devId" type="hidden" id="devId" size="19"
										value="aa07b80f0c104ba38ebfb049c375997f"> <input
									...
									<td class="ta_01" bgColor="#ffffff"><font face="宋体"
										color="red"> <input name="useDate" type="text"
											maxlength="25" id="useDate" size="19" value="2007-05-28"
											disabled></font></td>
								</tr>
								<tr>
									<td width="153" class="ta_01" align="center" bgcolor="#f5fafe"
								...
								<tr>
									...
									<td class="ta_01" bgcolor="#ffffff"><font face="宋体"
										color="red"> <input name="startDate" type="text"
											...
											onclick="JavaScript:calendar(this)"></font>&nbsp;<font
								...
								<TR>
									...
									<TD class="ta_01" bgColor="#ffffff" colSpan="3"><select
										...
										style="DISPLAY: none"> <input
											...
											onClick="openWindowWithName('adjustFile.jsp?ZhengRi1=1&devId=aa07b80f0c104ba38ebfb049c375997f',800,450,'ECC');" />
									</span></TD>
								</TR>
